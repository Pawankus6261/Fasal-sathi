...
import { 
  ...
  ChevronRight, Activity, Zap, Play, Info, Timer
...
export default function IrrigationScreen() {
  ...
  const [zones, setZones] = useState([
    { id: 1, name: 'Zone A', crop: 'Wheat Field', moisture: 28, on: true, status: 'critical', flow: '320 L/h', duration: '45m left' },
    { id: 2, name: 'Zone B', crop: 'Soybean', moisture: 52, on: false, status: 'safe', flow: '0 L/h', duration: 'Scheduled' },
  ]);
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f8fafc' }} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-white rounded-[32px] p-7 border border-slate-100 shadow-sm shadow-slate-300/30 mt-2">
           <View className="flex-row justify-between items-center mb-8">
              <View>
              ...
              <TouchableOpacity className="bg-slate-50 px-4 py-2 rounded-xl border border-slate-100">
                <Text style={{ fontFamily: W.Bold, fontSize: 11, color: '#059669' }}>EXPORT PDF</Text>
              </TouchableOpacity>
           </View>
